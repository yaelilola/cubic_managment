...
urlpatterns = [
    ...
    path('campuses/<str:campus_id>/buildings/<str:building_id>/floors/<str:floor_id>/spaces/',
         facilities_views.display_floor, name="floor_spaces"),
    path('campuses/<str:campus_id>/buildings/<str:building_id>/floors/<str:floor_id>/spaces/<str:space_id>/cubicsandlabs/',
         facilities_views.display_space, name='space_cubics'),
    path('campuses/<str:campus_id>/buildings/<str:building_id>/floors/<str:floor_id>/spaces/<str:space_id>/cubics/<str:cubic_id>/',
